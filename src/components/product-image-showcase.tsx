...
export function ProductImageShowcase({ image, alt, badge, stone = false }: ProductImageShowcaseProps) {
  ...
  return (
    <div className="relative overflow-hidden rounded-[2rem] border border-[#d8ccbd] bg-[#e5ddd2] shadow-[0_18px_45px_rgba(74,53,36,0.08)]">
      <div className="relative aspect-[4/3] bg-[radial-gradient(circle_at_center,#f7f1e8_0%,#e5ddd2_72%)]">
        <Image
          src={imageSrc}
          alt={alt}
          fill
          ...
          className={stone ? "object-cover" : "object-contain p-[7%] drop-shadow-[0_16px_18px_rgba(74,53,36,0.18)]"}
        />
      </div>
